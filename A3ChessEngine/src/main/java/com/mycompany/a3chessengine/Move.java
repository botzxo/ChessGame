...
public abstract class Move {
    ...
    public int hashCode() {
        ...
        // Compute hash codes for the critical fields in the same manner as used in equals.
        result = prime * result + (movedPiece != null ? movedPiece.hashCode() : 0);
        result = prime * result + destinationCoordX;
        result = prime * result + destinationCoordY;
        result = prime * result + (isAttack() ? 1 : 0);
